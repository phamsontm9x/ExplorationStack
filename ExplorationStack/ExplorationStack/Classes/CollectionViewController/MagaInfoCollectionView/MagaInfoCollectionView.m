...
@interface MagaInfoCollectionView () <UICollectionViewDelegateFlowLayout>

@property (nonatomic, strong) NSMutableArray *arrColor;

@end

@implementation MagaInfoCollectionView
...
- (void)viewDidLoad {
    ...
    [_arrColor addObject:[UIColor redColor]];
